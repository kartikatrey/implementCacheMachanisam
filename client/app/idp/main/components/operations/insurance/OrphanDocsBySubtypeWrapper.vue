...
export default {
  name: "OrphanDocsBySubtypeWrapper",
  ...
  methods: {
    ...
    async setChartData() {
        let chartResult = await IdpChartService.getChartData({
            chart_name: "OrphanDocsBySubtypeWrapper",
      ...
      values= values.map((value) => {
        // in case if document_subtype is null we should name it as 'Unknown'
      ...
      this.$store.commit('dashboardStore/setdashboardComponentStatus','OrphanDocsBySubtypeWrapper');
    },
  },
  beforeMount() {
