<template>
  <main class="kp-main">
    <idp-list-header title="Meter Readings" :tableProps="tableProps" :filter="filter" :isReviewerOnly="isReviewerOnly"></idp-list-header>
    <div class="page-body">
...
export default {
  ...
  data() {
    return {
      ...
      tableProps: {  
        ...
        tableIdentifier: "idp_meter_reading_list",
        ...
        query: {
          stage: {'$in': [Constants.DOCEX.STAGE.UPLOADED,Constants.DOCEX.STAGE.EXTRACTED ]},
          active: true,
          document_type: Constants.DOCEX.DOCUMENT_TYPES.METER_READING,
  ...
  beforeMount() {
    ...
    EventBus.$emit("SET_DOCUMENT_TYPE", Constants.DOCEX.DOCUMENT_TYPES.METER_READING);
