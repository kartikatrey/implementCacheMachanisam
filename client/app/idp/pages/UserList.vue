...
export default {
  ...
  methods: {
          columnTemplate(props) {
            var htmlTemplate = "";
            if (props.row["active"]) {
                htmlTemplate = `<div data-v-c0ac797e="" cid="${'row-' + props.column.field + '-'+ props.index}" class="el-badge mark"><sup class="badge-active">Active</sup></div>`;
            } else {
                htmlTemplate = `<div data-v-c0ac797e="" cid="${'row-' + props.column.field + '-'+ props.index}" class="el-badge mark"><sup class="badge-pending">Inactive</sup></div>`;
            }
            return htmlTemplate;
        }
  },
